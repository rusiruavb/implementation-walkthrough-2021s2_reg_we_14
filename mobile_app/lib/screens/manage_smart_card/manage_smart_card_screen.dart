...
import 'package:mobile_app/screens/manage_smart_card/smart_card_content.dart';
import 'package:provider/provider.dart';

import '../../../constants.dart';

class ManageSmartCardScreen extends StatefulWidget {
  @override
  _ManageSmartCardState createState() => _ManageSmartCardState();
}

class _ManageSmartCardState extends State<ManageSmartCardScreen> {
  Future<PassengerProfileModel> profileData;
  PassengerProfileModel _passengerData;
  final _scaffoldKey = GlobalKey<ScaffoldState>(debugLabel: 'paymentScreenKey');
