...
class OnlineRecharge extends StatefulWidget {
  @override
  _OnlineRechargeState createState() => _OnlineRechargeState();
}

class _OnlineRechargeState extends State<OnlineRecharge> {
  @override
  void initState() {
    super.initState();
  }
                              ...
                              Column(
                                children: <Widget>[
                                  Row(
                                    children: [
                                      Text(
                                        value.smartCardData.packageName,
                                        style: TextStyle(
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        'Available amount Rs.' +
                                            value.smartCardData.availableAmout
                                                .toStringAsFixed(2),
                                        style: TextStyle(
                                          fontFamily: INTER_MEDIUM,
                                          fontSize: 18,
...
class _CardDataInputFomrState extends State<_CardDataInputForm> {
  GlobalKey<FormState> _cardInputFormKey =
      GlobalKey<FormState>(debugLabel: '_onlinePaymentFormKey');
