...
import 'package:mobile_app/screens/apply_smart_card/package/package_content.dart';
...
class _PackageScreenState extends State<PackagesScreen> {
  Future<PassengerProfileModel> profileData;
  PassengerProfileModel _passengerData;
  final _scaffoldKey =
      GlobalKey<ScaffoldState>(debugLabel: 'applySmartCardScreenKey');
