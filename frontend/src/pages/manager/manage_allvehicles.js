...
import { getAllVehicles,getVehicleById, setVehicle, deleteVehicle  } from "../../actions/vehicle_action";
import moment from "moment";
import Loader from "../loader";
import Bus from "./add_bus";
import Train from "./add_train";
import Metro from "./add_metro";
...
class ManageVehicles extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="p-4 admin-container-color" id="bus">
...
const mapStateToProps = (state) => ({
  getvehicle: state.vehicleReducer.getvehicle,
  getvehicleerror: state.vehicleReducer.getstudenterror,
  getallvehicles: state.vehicleReducer.getallvehicles,
  createvehicle: state.vehicleReducer.createvehicle,
  createvehicleerror: state.vehicleReducer.createvehicleerror,
  updatevehicle: state.vehicleReducer.updatevehicle,
  updatevehicleerror: state.vehicleReducer.updatevehicleerror,
  deletevehicle: state.vehicleReducer.deletevehicle,
