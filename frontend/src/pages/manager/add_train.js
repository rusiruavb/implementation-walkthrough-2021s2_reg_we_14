    ...
    if (this.validateForm()) {
      ...
      if (!data.includes(false)) {
        let vehicleData = {
          ...
          capacityPerCoach: this.state.capacityPerCoach,
    ...
    const data = {
      ...
      numberOfCoaches:
        numberOfCoaches && numberOfCoaches.toString().trim().length > 0
          ...
          : null,
      capacityPerCoach:
        capacityPerCoach && capacityPerCoach.toString().trim().length > 0
          ? capacityPerCoach
          : null,
            ...
            <div className="container-add card">
              ...
              <div className="row">
                ...
                <div className="row">
                  <div className="row m-2 mb-2 col">
                    <label
                      htmlFor="capacityPerCoach"
                      className="form-label p-0"
                    >
                      Capacity per Coaches
                    </label>
                    <input
                      type="text"
                      id="capacityPerCoach"
                      className="form-control"
                      name="capacityPerCoach"
                      value={this.state.capacityPerCoach}
                      onChange={this.onChange}
                    />
                    {formData.capacityPerCoach === null &&
                    this.state.formNotValid ? (
                      <span className="text-danger validation-text p-0">
                        Number of Coaches in Vehicle is required
                      </span>
                    ) : null}
                  </div>
